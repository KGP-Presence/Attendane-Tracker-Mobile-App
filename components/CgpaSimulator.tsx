...
export default function CgpaSimulator({ visible, onClose }: CgpaSimulatorProps) {
  ...
  // Load persisted data on mount/visible
  useEffect(() => {
    if (visible) {
        ...
        <View className="flex-1 bg-black/50 justify-end">
          <View className="bg-white dark:bg-[#1a2230] rounded-t-3xl px-5 pt-4 pb-8 max-h-[90%]">
            ...
            >
              ...
              {/* Mode Toggle */}
              <View className="flex-row mb-4 bg-gray-100 dark:bg-[#0f1520] rounded-lg p-1">
                <TouchableOpacity
              ...
              {mode === "whatif" && (
                <View className="pb-4">
                  ...
                  {inputsValid && projectedCGPA !== null && (
                    <View className="mt-4 bg-[#135bec]/10 border border-[#135bec]/20 rounded-lg p-3">
              ...
              {mode === "target" && (
                <View className="pb-4">
                  ...
                  <TextInput
                    className="bg-gray-50 dark:bg-[#0f1520] border border-gray-200 dark:border-gray-700 rounded-lg px-3 py-2.5 text-[#111318] dark:text-white text-base mb-4"
              ...
              {/* Privacy Badge */}
              <View className="flex-row items-center justify-center gap-1 py-3 border-t border-gray-100 dark:border-gray-700 mt-4">
